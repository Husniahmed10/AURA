...
export default function ScanDetailPage({
  ...
  const progress = scan
    ? Math.min(
        100,
        Math.round((scan.attacks_completed / (scan.max_attacks || 1)) * 100),
      )
    : 0;
    ...
    <div className="page-stack">
      ...
      >
        <div>
          ...
          <p className="mono break-all mb-2 muted">{id}</p>
      ...
      {abort.isError && (
        <div className="notice error" role="alert">
          Unable to stop the assessment. Please try again.
        </div>
      )}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <MetricCard
          label="Attacks Completed"
          icon={Zap}
          value={
            <div>
              <span
        ...
        <MetricCard
          ...
          value={
            ...
            >
              {formatDistanceToNow(new Date(scan.updated_at), {
                addSuffix: true,
              })}
            </span>
          }
      ...
      {scan.max_attacks > 0 && (
        <div className="glass-card p-5 space-y-3">
          ...
          >
            ...
            <span>
              {Math.max(0, scan.max_attacks - scan.attacks_completed)} remaining
            </span>
          </div>
        </div>
      )}
      ...
      {scan.error && (
        ...
        >
          <AlertTriangle
            size={16}
            style={{ color: "#FF2D55", flexShrink: 0, marginTop: 2 }}
          />
          <div>
